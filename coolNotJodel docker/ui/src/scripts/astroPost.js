class AstroPost extends HTMLElement {
  ...
  setValues() {
    ...
    a.href = "http://localhost:7800/posts/" + this.attributes.pid.value;
    ...
    btnUp.addEventListener("click", () => {
      fetch("http://my-api-app-service:7778/api/upvote", {
        method: "PATCH",
        headers: {
    ...
    btnDown.addEventListener("click", () => {
      fetch("http://my-api-app-service:7778/api/downvote", {
        method: "PATCH",
        headers: {
          "Accept": "application/json",
          "Content-Type": "application/json",
